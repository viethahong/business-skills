...
description: "When the user wants to: thiết kế chương trình giới thiệu (Referral/Affiliate) và các cơ chế Viral Loop. Kích hoạt khi nhắc đến 'chương trình giới thiệu', 'khách cũ kéo khách mới', 'affiliate', 'mã giảm giá giới thiệu' hoặc 'viral growth'."
version: 2.1.0
---

# Referral & Viral Growth (Chương trình Giới thiệu & Tăng trưởng Lan tỏa)
...
1. **Thiết kế Cơ chế Thưởng (Incentive Engineering)**:
    - **Double-sided Reward**: Cả người giới thiệu và người được giới thiệu đều có lợi (Ví dụ: Dropbox tặng dung lượng cho cả hai).
    - Lựa chọn loại thưởng: Tiền mặt, Credit mua hàng, Nâng cấp tính năng hoặc Quà tặng vật lý độc quyền.

2. **Xác định Thời điểm "Vàng" (Moment of Wow)**:
    - Yêu cầu giới thiệu ngay sau khi khách hàng đạt được giá trị (Aha! Moment) hoặc có phản hồi tích cực.
    - Tránh yêu cầu quá sớm khi khách chưa trải nghiệm đủ giá trị sản phẩm.

3. **Tối ưu hóa Luồng Chia sẻ (Seamless Sharing UX)**:
    - Quy tắc 1-Click: Việc chia sẻ mã/link phải cực kỳ đơn giản qua Zalo, Facebook, Email.
    - Thiết kế các "Social Assets" (Ảnh, thông điệp) đẹp mắt để khách hàng tự hào khi chia sẻ.

4. **Xây dựng Viral Loops (Vòng lặp lan tỏa)**:
    - Thiết kế sản phẩm có tính năng "tự lan tỏa" (Ví dụ: Sản phẩm cần cộng tác, sản phẩm chia sẻ kết quả lên mạng xã hội).
    - Theo dõi hệ số K-factor (Số khách mới trung bình mà 1 khách cũ mời được).
...
2. **Referral Structure**: Đối tượng tham gia, Cơ chế thưởng (Người giới thiệu vs Người được giới thiệu), Điều kiện nhận thưởng.
...
## Edge cases
- **Sản phẩm mang tính cá nhân/bí mật**: Không dùng chương trình giới thiệu công khai. Thay vào đó, dùng cơ chế "Mời riêng tư" hoặc tặng quà tri ân không cần chia sẻ.
- **Dịch vụ B2B giá trị cao**: Thay thưởng tiền mặt bằng "Nâng cấp gói dịch vụ" hoặc "Đặc quyền tham gia cộng đồng VIP" để giữ tính chuyên nghiệp.
