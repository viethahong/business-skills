...
description: "Khi người dùng muốn: xây dựng gian hàng, tối ưu sản phẩm và vận hành bán hàng trên TikTok Shop Việt Nam. Kích hoạt khi nhắc đến 'mở TikTok Shop', 'tối ưu giỏ hàng TikTok', 'tìm KOC TikTok', 'set up Affiliate' hoặc 'tăng đơn TikTok Shop'."
version: 2.1.0
---

# TikTok Shop Strategy (Chiến lược Bán hàng TikTok Shop)
...
1. **Shop Setup & Optimization (Thiết lập & Tối ưu Gian hàng)**:
    - Tối ưu hóa SKU: Tiêu đề chuẩn SEO TikTok, bộ ảnh chuẩn 1:1, mô tả sản phẩm chứa keywords.
    - Cấu trúc giá và khuyến mãi: Flash Sale, Voucher người theo dõi mới, Combo khuyến mãi.

2. **Content-to-Commerce Workflow (Quy trình Nội dung Bán hàng)**:
    - Thiết kế kịch bản video ngắn 30-60s theo công thức: Hook (3s đầu) -> Value (Demo sản phẩm) -> CTA (Gắn giỏ hàng).
    - Lên lịch đăng bài và phối hợp với các phiên Livestream.

3. **TikTok Affiliate & KOC Strategy (Chiến lược Tiếp thị Liên kết)**:
    - Thiết lập mức hoa hồng (Commission) hấp dẫn cho từng nhóm sản phẩm.
    - Sàng lọc và gửi mẫu cho KOC (Key Opinion Consumers) phù hợp với tệp khách hàng mục tiêu.

4. **Ads & Traffic Optimization (Tối ưu Lưu lượng)**:
    - Chạy quảng cáo mua sắm (Shopping Ads) để boost cho các video hoặc livestream đang có hiệu quả tốt.
    - Tối ưu hóa phễu từ Click giỏ hàng đến Thanh toán thành công.
...
2. **Product Listing Audit**: Đề xuất tối ưu tiêu đề/ảnh cho 3-5 SKU chủ lực.
...
## Edge cases
- **Shop mới 0 followers**: Tập trung 100% vào Affiliate Marketing (thuê KOC review) và chạy Shopping Ads để lấy dữ liệu máy học ban đầu.
- **Tỷ lệ hoàn hàng cao**: Kiểm tra lại sự đồng nhất giữa nội dung quảng cáo và thực tế sản phẩm; tối ưu quy trình CSKH sau khi khách đặt đơn.
...
- [Công thức Nội dung TikTok (Content Formula)](references/tiktok-content-formula.md): Các cấu trúc video ngắn dễ lên xu hướng.
- [Mẫu Kịch bản Livestream Sơ bộ](references/livestream-script-template.md): Khung kịch bản cho shop mới bắt đầu.
- [Kịch bản Kiểm thử TikTok Shop (Evals)](evals/test-tiktok-shop.md): Tình huống đánh giá khả năng vận hành gian hàng.
