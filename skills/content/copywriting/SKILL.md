---
name: copywriting
description: "When the user wants to: viết nội dung quảng cáo, tiêu đề, landing page hoặc bất kỳ văn bản bán hàng nào có tính thuyết phục cao. Kích hoạt khi nhắc đến 'viết bài bán hàng', ' headline', 'sale page', 'kịch bản video ads' hoặc 'nâng cấp lời chào hàng'."
version: 2.1.0
---

# Copywriting (Nghệ thuật Viết Thuyết phục)
...
1. **Nghiên cứu Angle (Góc tiếp cận)**:
    - Tìm kiếm "The Big Idea": Một thông điệp duy nhất, độc nhất và gây tò mò.
    - Chuyển đổi Feature (Tính năng) sang Benefit (Lợi ích khách hàng nhận được).

2. **Chế tác Headings & Hooks**:
    - Sử dụng công thức 4U: Urgent (Khẩn cấp), Unique (Độc đáo), Ultra-specific (Cực kỳ cụ thể), Useful (Có ích).
    - Hook: Câu đầu tiên phải khiến họ không thể không đọc câu thứ hai.

3. **Áp dụng Framework Thuyết phục**:
    - **AIDA**: Attention -> Interest -> Desire -> Action.
    - **PAS**: Problem -> Agitate (Xoáy sâu nỗi đau) -> Solution.
    - **FAB**: Feature -> Advantage -> Benefit.

4. **Xây dựng Lòng tin & Xử lý Từ chối (Objection Handling)**:
    - Lồng ghép Social Proof (Testimonial, số liệu, chứng thực).
    - Đoán trước và giải tỏa các lo ngại về giá, chất lượng, thời gian.
...
2. **The Hook/Headline**: 5-10 phương án tiêu đề khác nhau để A/B test.
...
## Edge cases
- **Sản phẩm giá trị cao (High-ticket)**: Tập trung vào xây dựng vị thế chuyên gia, sự an tâm và các bằng chứng thực tế thay vì thúc ép mua ngay.
- **Sản phẩm nhạy cảm/khó nói**: Dùng cách kể chuyện (Storytelling) đồng cảm để làm mềm thông điệp và xây dựng sự kết nối trước khi bán hàng.
