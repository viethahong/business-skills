...
description: "Khi người dùng muốn: tối ưu gian hàng, quản lý vận hành và chạy quảng cáo trên các sàn TMĐT như Shopee, Lazada, TikTok Shop. Kích hoạt khi nhắc đến 'tối ưu sản phẩm Shopee', 'chạy Shopee Ads', 'đăng ký Flash Sale', 'tăng điểm uy tín shop' hoặc 'vận hành gian hàng thương mại điện tử'."
version: 2.1.0
---

# Ecommerce Marketplace (Vận hành & Tăng trưởng Sàn TMĐT)
...
1. **Product Listing Optimization (Tối ưu Hiển thị Sản phẩm)**:
    - SEO sàn: Đặt tiêu đề sản phẩm chứa keywords có lượt tìm kiếm cao nhất.
    - Hình ảnh & Video: Thiết kế ảnh bìa (Thumbnail) bắt mắt, chứa thông tin khuyến mãi; quay video demo sản phẩm thực tế.
    - Mô tả sản phẩm: Viết rõ ràng các thông số kỹ thuật và lợi ích kèm các hashtags liên quan.

2. **Marketplace Ads Management (Quản lý Quảng cáo nội sàn)**:
    - Thiết lập đấu thầu từ khóa (Search Ads) cho các sản phẩm chủ lực.
    - Chạy quảng cáo khám phá (Discovery Ads) để hiển thị tại các mục gợi ý sản phẩm liên quan.
    - Theo dõi ROAS (Lợi nhuận trên chi phí quảng cáo) và điều chỉnh giá thầu hàng ngày.

3. **Campaign & Promotion Strategy (Chiến lược Khuyến mãi)**:
    - Đăng ký tham gia các đợt Flash Sale của sàn và các Campaign lớn (Vd: 9.9, 11.11, 12.12).
    - Thiết lập các công cụ marketing của shop: Voucher, Combo khuyến mãi, Mua kèm deal sốc.

4. **Shop Operations & Rating (Vận hành & Uy tín Shop)**:
    - Tối ưu hóa quy trình xử lý đơn hàng để giảm tỷ lệ hoàn/hủy.
    - Quản lý đánh giá (Reviews): Khuyến khích khách hàng đánh giá 5 sao và xử lý chuyên nghiệp các khiếu nại.
...
2. **Shop Audit Report**: Đánh giá hiện trạng gian hàng (Về SEO, hình ảnh, đánh giá).
...
## Edge cases
- **Shop mới 0 lượt bán**: Tập trung vào việc "mồi" đơn từ khách hàng quen, chạy quảng cáo từ khóa giá rẻ và tham gia các chương trình hỗ trợ shop mới của sàn.
- **Sản phẩm bị đối thủ phá giá**: Tập trung vào việc gia tăng giá trị quà tặng kèm hoặc cải thiện hình ảnh chuyên nghiệp để giữ mức giá cao hơn nhưng chất lượng hơn.
...
- [Hướng dẫn Quảng cáo nội sàn (Ads Guide)](references/marketplace-ads-guide.md): Cách bid giá và tối ưu ROAS.
- [Kịch bản Kiểm thử Marketplace (Evals)](evals/test-shopee-listing.md): Tình huống đánh giá khả năng tối ưu và vận hành shop.
- [Mẫu Ảnh bìa & Frame sản phẩm](link): Các template thiết kế ảnh chuẩn sàn.
