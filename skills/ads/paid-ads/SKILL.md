---
name: paid-ads
description: "When the user wants to: xây dựng và tối ưu chiến dịch quảng cáo trả phí (Facebook, Google, TikTok, Shopee Ads). Kích hoạt khi nhắc đến 'chạy quảng cáo', 'tăng ROAS', 'giảm CPA', 'targeting', 'pixel', 'scale ngân sách' hoặc 'audit tài khoản quảng cáo'."
version: 2.1.0
---
...
2. **Campaign Blueprint**: Sơ đồ cấu trúc TOF-MOF-BOF và phân bổ ngân sách dự kiến.
...
## Edge cases
- **Ngân sách quá thấp**: Tập trung 100% vào tệp khách hàng nóng nhất (Retargeting) hoặc tệp siêu ngách (Ultra-niche) để tối ưu CPA.
- **Tài khoản quảng cáo bị khóa/vô hiệu hóa**: Luôn có phương án dự phòng (Backup accounts) và quy trình kháng nghị chuyên nghiệp.
